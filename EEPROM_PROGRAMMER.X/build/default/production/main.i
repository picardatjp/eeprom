...
void shiftOutByte(int data)
{
    ...
    for(i=0;i<8;i++)
    {
        PORTAbits.RA4 = (0b10000000 & data) >> 7;
        data = data << 1;
        pulseClock();
    }
    pulseLatch();
...
void writeByteToEEPROM(int address, int data)
{
    ...
    PORTAbits.RA0 = 1 & data;
    data = data >> 1;
    PORTAbits.RA1 = 1 & data;
    data = data >> 1;
    PORTAbits.RA2 = 1 & data;
    data = data >> 1;
    PORTCbits.RC0 = 1 & data;
    data = data >> 1;
    PORTCbits.RC1 = 1 & data;
    data = data >> 1;
    PORTCbits.RC2 = 1 & data;
    data = data >> 1;
    PORTBbits.RB4 = 1 & data;
    data = data >> 1;
    PORTBbits.RB5 = 1 & data;
...
void pulseWriteEn()
{
    _delay((unsigned long)((800)*(500000/4000000.0)));
    PORTCbits.RC7 = 0;
    _delay((unsigned long)((800)*(500000/4000000.0)));
    PORTCbits.RC7 = 1;
